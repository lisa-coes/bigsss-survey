...
df_lik1 %>% 
  ...
  setNames(get_label(.)) %>% 
  likert() %>%
  plot(low.color="#D30132",high.color='#5586B4',wrap=40,plot.percents=TRUE, plot.percent.low=FALSE, plot.percent.high=FALSE, plot.percent.neutral=FALSE,text.size=4)+
